/* To complie:
   g++ -O3 racon_spoa.cpp -std=c++11 -I include/ -L build/lib/ -lspoa -o racon_spoa
  */
...
// read fasta format
string get_seq(ifstream& in_file, bool *start)
{
    char c = in_file.get();
...
int main(int argc, char** argv) {
    ...
    char opt; char *s;
    while ((opt = getopt(argc, argv, "l:m:x:o:e:q:c:s:h")) != -1) {
        switch (opt) {
